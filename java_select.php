...
<div style="background-color:white; width:100%; height:500px; margin-left:0px; color:black;"><h1 style="text-align:center;">Total student</h1>
...
<th><h5 style="text-align:center; font-size:20px;">batch_No.</h5></th>
...
require'$con.php';
 ...
 $qry = "SELECT * FROM student WHERE subject='java'";
...
$result=mysqli_query($con,$qry);
	...
	echo '</td>';
	echo '<td>';
	echo "<a href='student_delete.php?id=$id'>
